<div id="modal-prescricao-ambulatorial" class="modal fade modal-prescricao"  tabindex="-1" role="dialog" aria-labelledby="myModalLabel" aria-hidden="true">
    <div class="modal-dialog dialog-prescricao" role="document">
        <div class="modal-content content-prescricao">
            <div class="modal-header">
                ...
                <h3 class="modal-title">Prescrição ambulatorial</h3>
            </div>
            <div class="modal-body modal-body-scroll-500">
                ...
                <div class="panel-body">
                    <div class="btn-group" role="group">
                        <input class="btn btn-info btn-exibe-prescricao-ambulatorial" data-titulo="Dieta" data-configuracao="dieta" value="Dieta" type="button">
                        <input class="btn btn-info btn-exibe-prescricao-ambulatorial" data-titulo="Controle de sinais vitais" data-configuracao="sinais-vitais" value="C.S.V." type="button">
                        <input class="btn btn-info btn-exibe-prescricao-ambulatorial" data-titulo="Outros cuidados" data-configuracao="outros-cuidados" value="Outros cuidados" type="button">
                        <input class="btn btn-info btn-exibe-prescricao-ambulatorial" data-titulo="Oxigenoterapia" data-configuracao="oxigenoterapia" value="Oxigenoterapia" type="button">
                        <input class="btn btn-info btn-exibe-prescricao-ambulatorial" data-titulo="Medicação" data-configuracao="medicacao" value="Medicaçao" type="button">
                    </div>
                    <div class="btn-group" id="ver_todas_prescricoes" role="group">
                        <button class="btn btn-cinza" title="Ver prescrição anterior"><span class="fas fa-caret-left"></span></button>
                        <button class="btn btn-cinza" title="Ver próxima prescrição"><span class="fas fa-caret-right"></span></button>
                    </div>
                    <div class="btn-group" role="group">
                    ...
                    <a style="display: none" id="rota_prescricao_ambulatorial" href="{{ route('relatorios/prescricao-ambulatorial').'/'.$acolhimento->cd_prontuario }}" target="_blank" class="btn btn-primary pull-right"><span class="fa fa-print"></span></a>
                </div>
                <div class="col-md-12">
                    <div class="panel-body painel-geral" id="painel-geral-ambulatorial">
                        <div id="div-ambulatorial-outros-cuidados" style="display: none">
                        ...
                        <div id="div-ambulatorial-oxigenoterapia" style="display: none">
                        ...
                        <div id="div-ambulatorial-dieta" style="display: none">
                        ...
                        <div id="div-ambulatorial-sinais-vitais" style="display: none">
                        ...
                        <div id="div-ambulatorial-medicacao" style="display: none">
