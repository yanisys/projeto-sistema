            ...
            <div class="modal-body modal-body-scroll-500">
                ...
                <div id="div-mostra-botoes-prescricao-ambulatorial">
                    <div class="panel-body">
                        ...
                        <a style="display: none" id="rota_prescricao_ambulatorial" href="{{ route('relatorios/prescricao-ambulatorial').'/'.$acolhimento->cd_prontuario.'/1'}}" target="_blank" class="btn btn-primary pull-right"><span class="fa fa-print"></span></a>
                            ...
                            <div class="row">
                                <div class="col-md-3">
                                    <div class="form-group">
                                        ...
                                        {{ Form::select('cd_exame_laboratorial',arrayPadrao('exames_laboratoriais'),(isset($_POST['cd_exame_laboratorial']) ? $_POST['cd_exame_laboratorial'] : ""),["id" => "cd_exame_laboratorial", 'class'=> "form-control"]) }}
                                    </div>
                                </div>
                                <div class="col-md-7">
                                    <div class="form-group">
                                        <label for="observacao_exame_laboratorial">Observação/ Recomendação</label>
                                        {{ Form::text('observacao_exame_laboratorial', (isset($_POST['observacao_exame_laboratorial']) ? $_POST['observacao_exame_laboratorial'] : "") ,["maxlength" => "200", "id" => "observacao_exame_laboratorial", 'class'=> "form-control" ]) }}
                                    </div>
                                </div>
                                <div class="col-md-2">
                                        ...
                                        <div class="input-group">
                                            ...
                                            <div class="input-group-btn">
                                                ...
                                                <ul class="dropdown-menu dropdown-menu-right">
                                                    @foreach(['2' => 'hr(s)'] as $key=>$periodo)
                                                        <li class="itens" data-nome="intervalo_oxigenoterapia" data-valor="{{$key}}" data-texto="{{$periodo}}"><a href="#">{{$periodo}}</a></li>
                                                    @endforeach
                                                </ul>
                                            </div>
                                        </div>
                                    ...
                                    <div class="form-group">
                                        ...
                                        <div class="input-group">
                                            ...
                                            <div class="input-group-btn">
                                                ...
                                                <ul class="dropdown-menu dropdown-menu-right">
                                                    @foreach(['2' => 'hr(s)'] as $key=>$periodo)
                                                        <li class="itens" data-nome="prazo_oxigenoterapia" data-valor="{{$key}}" data-texto="{{$periodo}}"><a href="#">{{$periodo}}</a></li>
                                                    @endforeach
                                                </ul>
                                            </div>
                                        </div>
                                ...
                                <div class="col-md-2">
                                    <div class="form-group">
                                        ...
                                        <div class="input-group">
                                            ...
                                            {{ Form::text('aprazamento_oxigenoterapia', (isset($_POST['aprazamento_oxigenoterapia']) ? $_POST['aprazamento_oxigenoterapia'] : "") ,["name" => "aprazamento_oxigenoterapia[]", "maxlength" => "5", "id" => "aprazamento_oxigenoterapia", 'class'=> "form-control font-8 mask-hora" ]) }}
                                        </div>
                                    </div>
                                </div>
                                    ...
                                    <div class="form-group">
                                        ...
                                        <div class="input-group">
                                            ...
                                            <div class="input-group-btn">
                                                ...
                                                <ul class="dropdown-menu dropdown-menu-right">
                                                    @foreach(['2' => 'hr(s)'] as $key=>$periodo)
                                                        <li class="itens" data-nome="intervalo_dieta" data-valor="{{$key}}" data-texto="{{$periodo}}"><a href="#">{{$periodo}}</a></li>
                                                    @endforeach
                                                </ul>
                                            </div>
                                        </div>
                                    ...
                                    <div class="form-group">
                                        ...
                                        <div class="input-group">
                                            ...
                                            <div class="input-group-btn">
                                                ...
                                                <ul class="dropdown-menu dropdown-menu-right">
                                                    @foreach(['2' => 'hr(s)'] as $key=>$periodo)
                                                        <li class="itens" data-nome="prazo_dieta" data-valor="{{$key}}" data-texto="{{$periodo}}"><a href="#">{{$periodo}}</a></li>
                                                    @endforeach
                                                </ul>
                                            </div>
                                        </div>
                            ...
                            <div class="row">
                                <div class="col-md-2">
                                    <div class="form-group">
                                        ...
                                        <div class="input-group">
                                            <div class="input-group-addon">Início:</div>
                                            {{ Form::text('aprazamento_dieta', (isset($_POST['aprazamento_dieta']) ? $_POST['aprazamento_dieta'] : "") ,["name" => "aprazamento_dieta[]", "maxlength" => "5", "id" => "aprazamento_dieta", 'class'=> "form-control font-8 mask-hora" ]) }}
                                        </div>
                                    </div>
                                </div>
                            ...
                            <div class="row">
                                <div class="col-md-10">
                                    <div class="form-group">
                                        ...
                                        {{ Form::text('descricao_dieta', (isset($_POST['descricao_dieta']) ? $_POST['descricao_dieta'] : "") ,["maxlength" => "200", "id" => "descricao_dieta", 'class'=> ($errors->has("descricao_dieta") ? "form-control is-invalid" : "form-control") ]) }}
                                    </div>
                                </div>
                                <div class="col-md-2">
                                    ...
                                    <div class="form-group">
                                        ...
                                        <div class="input-group">
                                            ...
                                            <div class="input-group-btn">
                                                ...
                                                <ul class="dropdown-menu dropdown-menu-right">
                                                    @foreach(['2' => 'hr(s)'] as $key=>$periodo)
                                                        <li class="itens" data-nome="intervalo_csv" data-valor="{{$key}}" data-texto="{{$periodo}}"><a href="#">{{$periodo}}</a></li>
                                                    @endforeach
                                                </ul>
                                            </div>
                                        </div>
                                    ...
                                    <div class="form-group">
                                        ...
                                        <div class="input-group">
                                            ...
                                            <div class="input-group-btn">
                                                ...
                                                <ul class="dropdown-menu dropdown-menu-right">
                                                    @foreach(['2' => 'hr(s)'] as $key=>$periodo)
                                                        <li class="itens" data-nome="prazo_csv" data-valor="{{$key}}" data-texto="{{$periodo}}"><a href="#">{{$periodo}}</a></li>
                                                    @endforeach
                                                </ul>
                                            </div>
                                        </div>
                            ...
                            <div class="row">
                                <div class="col-md-2">
                                    <div class="form-group">
                                        ...
                                        <div class="input-group">
                                            <div class="input-group-addon">Início:</div>
                                            {{ Form::text('aprazamento_csv', (isset($_POST['aprazamento_csv']) ? $_POST['aprazamento_csv'] : "") ,["name" => "aprazamento_csv[]", "maxlength" => "5", "id" => "aprazamento_csv", 'class'=> "form-control font-8 mask-hora" ]) }}
                                        </div>
                                    </div>
                                </div>
                                ...
                                <div class="col-md-3">
                                    <div class="form-group">
                                        <div class="input-group">
                                            ...
                                            <div class="input-group-btn">
                                                <button id="btn-dose" type="button" data-valor="1" data-texto="{{isset($unidades_medida) ? current($unidades_medida) : ''}}" class="btn dropdown-toggle margin-top-10 btn-branco" data-toggle="dropdown" aria-haspopup="true" aria-expanded="false">{{isset($unidades_medida) ? current($unidades_medida) : ''}}<span class="caret"></span></button>
                                                <ul class="dropdown-menu dropdown-menu-right">
                            ...
                            <div class="row">
                                <div class="col-md-2">
                                    <div class="form-group">
                                        ...
                                        <div class="input-group">
                                            <div class="input-group-addon">Início:</div>
                                            {{ Form::text('aprazamento_medicacao', (isset($_POST['aprazamento_medicacao']) ? $_POST['aprazamento_medicacao'] : "") ,["name" => "aprazamento_medicacao[]", "maxlength" => "5", "id" => "aprazamento_medicacao", 'class'=> "form-control font-8 mask-hora" ]) }}
                                        </div>
                                    </div>
                                </div>
...
@include('atendimentos/modal-medicamentos')
<script src="{{ js_versionado('modal_receituario.js') }}" defer></script>
