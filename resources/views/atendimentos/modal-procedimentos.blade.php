                ...
                <div class="row">
                    <div class="col-md-12">
                        <div class="form-group">
                            {{ Form::textarea('modal_descricao_solicitacao',"",["name" => "descricao_solicitacao", "placeholder" => "Digite aqui alguma observação para ser adicionada junto à este procedimento." , "maxlength" => "1000", "rows"=>"1", "id" => "modal_obs_procedimento",  'class'=> "form-control"]) }}
                        </div>
                    </div>
                </div>
            </div>
...
<script src="{{ js_versionado('modal_procedimentos.js') }}" defer></script>