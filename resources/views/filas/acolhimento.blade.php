                ...
                @foreach($prontuario as $p)
                    <tr>
                        ...
                        <td align="center" width="9%">
                            <a href="{{ route('atendimentos/acolhimento').'/'.$p->cd_prontuario }}" title='Acolher paciente' class="btn btn-primary fa fa-user-nurse {{ verficaPermissaoBotao('recurso.atendimentos/acolhimento')}}"></a>
                        </td>
                    </tr>
                @endforeach
            @endif
