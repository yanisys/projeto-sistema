...
<head>
    ...
    <title>{{ config('app.name', 'Nicola') }}</title>

    <!-- Scripts -->
    <script src="{{ asset('public/js/jquery3.1.1.min.js') }}"></script>
 <!--   <script src="{{ asset('public/js/jquery-ui.js') }}"></script> -->
    <script src="{{ asset('public/js/sweetalert2.min.js') }}"></script>
    <script src="{{ asset('public/js/bootstrap3.3.7.min.js') }}"></script>
    <script src="{{ asset('public/js/jquerymask1.14.10.js') }}"></script>
    ...
    <link rel="stylesheet" href="{{ asset('public/css/bootstrap3.3.7.css') }}" >
   <!-- <link rel="stylesheet" href="{{ asset('public/css/jquery-ui.css') }}" > -->
    <link rel="stylesheet" href="{{ asset('public/css/sweetalert2.css') }}">
  ...
  <!--  <link rel="stylesheet" href="https://cdnjs.cloudflare.com/ajax/libs/font-awesome/4.7.0/css/font-awesome.min.css"> -->
    <link rel="stylesheet" href="{{ asset('public/css/style_v1.10.css') }}">
