                    ...
                    <div class="row">
                        ...
                        <div class="col-md-6">
                            <div class="form-group">
                                ...
                                <?php echo e(Form::text('nm_sala', (isset($sala['nm_sala']) ? $sala['nm_sala'] : "") ,["maxlength" => "100", "id" => "nm_sala", "name" => "nm_sala", 'class'=> ($errors->has("nm_sala") ? "form-control is-invalid maiusculas" : "form-control maiusculas") ])); ?>
                        ...
                        <div class="col-sm-2">
                            <div class="form-group">
                                <label>Tipo</label>
                                <?php echo e(Form::select('tipo', arrayPadrao('tipo_sala'), (isset($sala['tipo']) ? $sala['tipo'] : "E"),['class'=>  "form-control", 'id' => 'tipo'])); ?>
                        ...
                        <div class="col-sm-2">
                            <div class="form-group">
                                ...
                                <?php echo e(Form::select('situacao', ['A'=>'Ativo', 'I'=>'Inativo'], (isset($sala['situacao']) ? $sala['situacao'] : "A"),['class'=>  "form-control", 'id' => 'situacao'])); ?>
