<?php $__env->startSection('conteudo'); ?>
    ...
    <div class="panel panel-primary" id="panel-acolhimento">
        <div class="panel-heading">
            <?php if(get_config(2,session()->get('estabelecimento')) == 'S'): ?>
            ...
            <button type="button" class="btn btn-primary pull pull-right" id="ver-historico" value='<?php echo e((isset($lista['cd_pessoa']) ? $lista['cd_pessoa'] : "")); ?>' data-toggle="modal" data-target="#modal-historico">Histórico</button>
            ...
            <div class="panel-body panel-acolhimento">
                ...
                <div class="row">
                    ...
                    <div class="col-md-3">
                        <div class="form-group">
                            ...
                            <?php echo e(Form::text('glicemia_capilar',(isset($lista['glicemia_capilar']) ? $lista['glicemia_capilar'] : ""),["name" => "glicemia_capilar", "maxlength" => "3", 'class'=> ($errors->has("glicemia_capilar") ? " mask-numeros-3 form-control is-invalid" : " mask-numeros-3 form-control")])); ?>
                ...
                <div class="row">
                    ...
                    <div class="col-md-4">
                        ...
                        <div class="panel-body panel-acolhimento">
                            <div class="range-control" id="<?php echo e(($lista['idade'] > 12) ? 'escala_dor_adulta' : 'escala_dor_infantil'); ?>">
                                <!-- <input id="inputRange" type="range" min="0" max="10" value="0" data-thumbwidth="1"> -->
                                <?php echo e(Form::range('nivel_de_dor',(isset($lista['nivel_de_dor']) ? $lista['nivel_de_dor'] : 0), ["id" => 'inputRange', "min" => 0, "max" => 10, "data-thumbwidth" => 1 ])); ?>
                            ...
                            <div class="row">
                                <div class="col-md-12">
                                    <div class="form-group">
                                        ...
                                        <?php echo e(Form::textarea('exames_apresentados',(isset($lista['exames_apresentados']) ? $lista['exames_apresentados'] : ""),["name" => "exames_apresentados", "maxlength" => "500", "rows"=>"3", "id" => "exames_apresentados",  'class'=> ($errors->has("exames_apresentados") ? "form-control is-invalid" : "form-control")])); ?>
                            ...
                            <div style="height: 100px;" class="panel-body">
                                <div class="form-group">
                                    ...
                                    <select id="classifica" class="form-control">
                                        ...
                                        <option value='7' style=background-color:white;><?php echo e(arrayPadrao('classificar_risco')[7]); ?></option>
                                        <option value='8' style=background-color:white;><?php echo e(arrayPadrao('classificar_risco')[8]); ?></option>
                                    </select>
                                </div>
        ...
        <div class="panel-footer fixed-panel-footer">
            <div class="pull-left"><?php echo e("Responsável: ".title_case(Session()->get('profissional')).' ' .Session()->get('nome')); ?>
                ...
                <?php $__currentLoopData = $salas; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $s): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                    <div id="sala-rodape"><?php echo e(($s->cd_sala == Session()->get('cd_sala')) ? title_case($s->nm_sala) : ''); ?></div>
                <?php endforeach; $__env->popLoop(); $loop = $__env->getLastLoop(); ?>
            </div>
            <div class="pull-right">
                <?php if((session()->get('recurso.atendimentos-acolhimento-salvar')) && session()->get('profissional')): ?>
