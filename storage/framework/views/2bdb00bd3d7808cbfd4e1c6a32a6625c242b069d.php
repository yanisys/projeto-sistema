<?php $__env->startSection('conteudo'); ?>
    ...
    <div class="table-responsive font-12px">
        <table class="table table-bordered table-hover table-striped">
            ...
            <tbody>
            <?php if((!isset($atendimento_interno) && !isset($atendimentos_direto_procedimentos)) || ($atendimento_interno->IsEmpty() && $atendimentos_direto_procedimentos->IsEmpty())): ?>
                <tr><td colspan="5">Sem resultados</td></tr>
            <?php else: ?>
                <?php $__currentLoopData = $atendimento_interno; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $p): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                    <tr>
                ...
                <?php $__currentLoopData = $atendimentos_direto_procedimentos; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $p): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                    <tr>
                        <td class='text-center'>
                            <?php echo e(formata_data_hora($p->created_at)); ?>
