        ...
        <div class="panel-body">
            ...
            <div class="row">
                <div class="col-sm-3">
                    ...
                    <?php echo Form::text('dt_inicial',(!empty($_REQUEST['dt_inicial']) ? $_REQUEST['dt_inicial'] : date('01/m/Y')),["name" => "dt_inicial", "placeholder" => "dd/mm/yyyy",'class'=>'form-control mask-data']); ?>

                </div>
                <div class="col-sm-3">
                    <label>Data final</label>
                    <?php echo Form::text('dt_final',(!empty($_REQUEST['dt_final']) ? $_REQUEST['dt_final'] : date('d/m/Y')),["name" => "dt_final", "placeholder" => "dd/mm/yyyy",'class'=>'form-control mask-data']); ?>

                </div>
                <div class="col-sm-6 ">
                    <?php echo Form::submit('Gerar Relatório',['class'=>"btn btn-default margin-top-25"]); ?>
