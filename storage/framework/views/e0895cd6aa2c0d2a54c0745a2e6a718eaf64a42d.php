<?php $__env->startSection('conteudo'); ?>
    ...
    <div class="panel panel-primary">
        <div class="panel-heading">
            <?php if(session()->get('profissional') && (session()->get('recurso.atendimentos-procedimentos-salvar'))): ?>
            ...
            <?php if($acolhimento->classificacao == 7): ?>
        ...
        <div class="panel-body">
            ...
            <div class="panel-body panel-acolhimento">
                <?php if(session()->get('profissional') && (session()->get('recurso.atendimentos-procedimentos-adicionar'))): ?>
                    ...
                    <div class="row">
                        <div class="col-md-12">
                            <div class="form-group">
                                ...
                                <?php echo e(Form::textarea('d_execucao',"",["name" => "descricao_execucao", "maxlength" => "2000", "rows"=>"15", "id" => "d_execucao",  'class'=> ($errors->has("descricao_execucao") ? "form-control input-sm is-invalid" : "form-control input-sm")])); ?>
                                <?php echo e(Form::hidden('d_id_atendimento_procedimento','',["name" => "id_atendimento_procedimento", "id" => "d_id_atendimento_procedimento"])); ?>
                                <?php echo e(Form::hidden('id_status','A',["name" => "id_status", "id" => "id_status_procedimento"])); ?>
                            </div>
                        </div>
                    </div>
                    <div class="row">
