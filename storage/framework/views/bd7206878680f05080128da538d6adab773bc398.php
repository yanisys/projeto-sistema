                        ...
                        <div class="tab-content">
                            <div class="tab-pane fade in active" id="tab_informacoes">
                                ...
                                <div class="row">
                                    ...
                                    <?php endif; ?>
                                    <div id="escolhe_cpf_cnpj" class="col-md-4">
                                        <div class="form-group">
                            ...
                            <div class="tab-pane fade" id="tab_pfisica">
                                ...
                                <div class="row">
                                    ...
                                    <div class="col-md-3">
                                        <div class="form-group">
                                            <label for="dt_nasc">Data de Nascimento<span style="color:red">*</span></label>
                                ...
                                <div class="row">
                                    ...
                                    <div class="col-md-4">
                                        <div class="form-group">
                                            <label for="cd_beneficiario">Cartão SUS</label>
                    ...
                    <div class="panel-body" id="panel-pesquisa">
                        <div class="container-fluid">
                            ...
                            <div class="col-sm-3">
                                ...
                                <input type="text" maxlength="60" id="cidade_pesquisa_cep" value="<?php echo e(session()->get('cidade_estabelecimento')); ?>" class="form-control">
                            </div>
                            <div class="col-sm-5">
                                <label id="nome" for="nome">Endereço</label>
                                <input type="text" maxlength="60" id="endereco_pesquisa_cep" placeholder="Digite um nome" class="form-control">
                            </div>
