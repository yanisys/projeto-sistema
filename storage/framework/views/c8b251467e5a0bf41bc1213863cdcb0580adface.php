            ...
            <?php else: ?>
                <?php $__currentLoopData = $prontuario; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $p): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                    <tr>
                        ...
                        <td class='text-center'>
                            <?php echo e($p->recepcionista); ?>

                        </td>
                        <td align="center" width="9%">
                            <a href="<?php echo e(route('atendimentos/acolhimento').'/'.$p->cd_prontuario); ?>" title='Acolher paciente' class="btn btn-primary fa fa-user-nurse <?php echo e(verficaPermissaoBotao('recurso.atendimentos/acolhimento')); ?>"></a>
                        </td>
                    </tr>
